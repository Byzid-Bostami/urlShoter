                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <a
                        ...
                        href={`http://localhost:4000/${item.shortUrl}`}
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        {`http://localhost:4000/${item.shortUrl}`.length > 25
                          ? `${`http://localhost:4000/${item.shortUrl}`.slice(
                              0,
                              25
                            )}...`
                          : `http://localhost:4000/${item.shortUrl}`}
                      </a>
                      <button
